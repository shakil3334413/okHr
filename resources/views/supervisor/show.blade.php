...
<div class="up-head-w" style="background-image:url(/img/supervisor/{{ $supervisor->image }})">
<div class="up-social">
...
<form id="formValidate" novalidate="true">
  ...
  <div class="form-group">
    <label for="" style=""> Name : </label> {{ $supervisor->name}}
  </div>
  <div class="form-group">
    <label for="" style=""> Email : </label> {{ $supervisor->email}}
  </div>
  <div class="form-group">
    <label for="" style=""> Phone : </label> {{ $supervisor->Phone}}
  </div>
  <div class="form-group">
    <label for="" style=""> Office Mail : </label> {{ $supervisor->officeEmail}}
  </div>

  <div class="form-group">
    <label for="" style=""> Department : </label> {{ $supervisor->department}}
  </div>
          ...
          <div class="chat-head">
            <div class="user-w with-status status-green">
              <div class="user-avatar-w">
                ...
                <img alt="" src="{{ URL::to('/') }}/img/supervisor/{{ $supervisor->image }}">
                </div>
              </div>
              <div class="user-name">
                <h6 class="user-title">
          ...
          <div class="profile-tile">
            <a class="profile-tile-box" href="users_profile_small.html">
              <div class="pt-avatar-w">
                <img alt="" src="{{url('storage/img/supervisor/'.$supervisor->image)}}">
              </div>
