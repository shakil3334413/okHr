...
<div class="up-head-w" style="background-image:url(/img/employee/{{ $leave->employee->image }})">
<div class="up-social">
...
<form id="formValidate" novalidate="true">
  ...
  <div class="form-group">
    <label for="" style=""> Name : </label> {{ $leave->employee->name }}
  </div>
  <div class="form-group">
    <label for="" style=""> Department : </label> {{ $leave->employee->department }}
  </div>
  <div class="form-group">
    <label for="" style=""> From : </label> {{ $leave->from_date }}
  </div>
  <div class="form-group">
    <label for="" style=""> To : </label> {{ $leave->to_date }}
  </div>
  <div class="form-group">
    <label for="" style=""> Total : </label> {{ abs(strtotime($leave->from_date) - strtotime($leave->to_date))/60/60/24 }}
  </div>
  <div class="form-group">
    <label for="" style=""> Leave Type : </label> {{ $leave->type}}
  </div>
  <div class="form-group">
    <label for="" style=""> Leave Reason : </label> {{ $leave->reason }}
  </div>
