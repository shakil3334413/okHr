...
@section('title',{{ $poject->name }})
@section('content')
<div class="content-i">
    <div class="content-box"><div class="row">
<div class="col-sm-5">
<div class="user-profile compact">
<div class="up-head-w" style="background-image:url(/img/supervisor/{{ $project->supervisor->image }})">
<div class="up-social">
...
<form id="formValidate" novalidate="true">
  ...
  <div class="form-group">
    <label for="" style=""> Name : </label> {{ $project->name}}
  </div>
  <div class="form-group">
    <label for="" style=""> Supervisor Name : </label> {{ $project->supervisor->name}}
  </div>
  <div class="form-group">
    <label for="" style=""> Supervisor officeEmail : </label> {{ $project->supervisor->officeEmail}}
  </div>
  <div class="form-group">
    <label for="" style=""> Supervisor Phone : </label> {{ $project->supervisor->Phone}}
  </div>
  <div class="form-group">
    <label for="" style=""> Assignee : </label> {{ $project->assignee}}
  </div>
  <div class="form-group">
    <label for="" style=""> Description : </label> {{ $project->description}}
  </div>
  <div class="form-group">
    <label for="" style=""> Status : </label> {{ $project->status=='0' ? 'Pending' : 'Done'}}
  </div>
          ...
          <div class="chat-head">
            <div class="user-w with-status status-green">
              <div class="user-avatar-w">
                ...
                <img alt="" src="{{ URL::to('/') }}/img/supervisor/{{ $project->supervisor->image }}">
                </div>
              </div>
              <div class="user-name">
                <h6 class="user-title">
          ...
          <div class="profile-tile">
            <a class="profile-tile-box" href="users_profile_small.html">
              <div class="pt-avatar-w">
                <img alt="" src="{{url('storage/img/supervisor/'.$project->supervisor->image)}}">
              </div>
